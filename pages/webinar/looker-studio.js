...
import WhatYouWillLearn from '../../components/LookerWeb'
            ...
            <div className='font-sans pb-16'>
                    ...
                    <header className="relative z-[1000] px-[5%] py-4 flex justify-between items-center">
                        ...
                        <div className="hidden w-[70%] lg:flex justify-between pr-40 items-center">
                            <div className="w-[80%] flex justify-around items-center text-[#464646] text-sm 2xl:text-[15px] font-bold">
                                <div onClick={scrolling1} className='cursor-pointer opacity-90 hover:opacity-100 hover:underline'>Webinar Date & Time</div>
                                <div onClick={scrolling2} className='cursor-pointer opacity-90 hover:opacity-100 hover:underline'>Our Speakers</div>
                                <div onClick={scrolling3} className='cursor-pointer opacity-90 hover:opacity-100 hover:underline'>What you’ll Learn</div>
                            </div>
                        ...
                        <div className="lg:hidden">
                            <button onClick={() => setMenuOpen(!menuOpen)} className="text-[#0D7078] text-2xl">
                                {menuOpen ? <FiX /> : <FiMenu />}
                            </button>
                        </div>
                        ...
                        {menuOpen && (
                            <div className="fixed top-16 left-0 w-full bg-white shadow-md p-5 flex flex-col gap-4 text-[#464646] font-semibold text-sm z-[999]">
                                <div className="border-b pb-2">Webinar Date & Time</div>
                                <div className="border-b pb-2">Our Speakers</div>
                                <div className="border-b pb-2">What you’ll Learn</div>
                                <div className="mt-2">
                                    <button onClick={scrolling} className="w-full flex items-center justify-center gap-2 bg-[#0D7078] text-white px-4 py-2 rounded-md text-sm">
                                        REGISTER NOW
                                    </button>
                                </div>
                            </div>
                    ...
                    <div className="relative z-20 flex flex-col lg:flex-row justify-between px-[5%] grow pt-5 2xl:pt-14 pb-12 3xl:pb-24 overflow-hidden">
                        ...
                        <div className="w-full lg:w-[45%] 3xl:w-[40%]">
                            ...
                            <div className="text-[#464646] text-lg 3xl:text-2xl font-normal pt-10">
                                ...
                                <br />
                                We share expert strategies on transforming raw data into compelling stories using Looker Studio.
                            </div>

                            <div id='webinar-time' className='shadow-webinarTime bg-[#8BCBFF4A] flex max-sm:grid max-sm:grid-cols-2 max-sm:gap-5 max-sm:mx-auto px-4 3xl:px-[25px] max-sm:py-8 py-4 2xl:py-[20px] mt-11 justify-between 3xl:justify-evenly items-start rounded-[17px] border border-[#B9B9B999]'>
                                <div className='flex flex-col items-center gap-3'>
                                    <img src='https://storage.googleapis.com/website-bucket-uploads/popup/Date.png' alt='' />
                                    <div className='text-xs text-center'>24 July 2025</div>
                                </div>
                                <div className='flex flex-col items-center gap-3'>
                                    <img src='https://storage.googleapis.com/website-bucket-uploads/popup/Time%20(1).png' alt='' />
                                    <div className='text-xs text-center'>8:00 PM IST<br></br>7:30 AM PST</div>
                                </div>
                                <div className='flex flex-col items-center gap-3'>
                                    <img src='https://storage.googleapis.com/website-bucket-uploads/popup/Duration%20(1).png' alt='' />
                                    <div className='text-xs text-center'>1 Hour</div>
                                </div>
                                <div className='flex flex-col items-center gap-3'>
                                    <img src='https://storage.googleapis.com/website-bucket-uploads/popup/Cost.png' alt='' />
                                    <div className='text-xs text-center'>Free</div>
                                </div>
                                <div className='max-sm:col-span-2 max-sm:flex max-sm:justify-center'>
                                    <button onClick={scrolling} className='bg-[#0C7077] shadow-teamShadow px-3 2xl:px-4 py-2 max-sm:mt-2 sm:my-4 flex justify-center items-center rounded-[10px] text-white'>
                                        <div className='text-sm 2xl:text-base font-bold'>REGISER NOW</div>
                                        <img src='https://storage.googleapis.com/website-bucket-uploads/popup/Right%20Arrow.png' alt='' />
                                    </button>
                                </div>
                            </div>
                ...
                <section className="w-full max-lg:px-[3%] lg:pl-[5%] pb-12 bg-white">
                    <div className="flex max-lg:flex-col justify-between items-center">
                        {/* Left Form */}
                        <div id='contact-form' className="w-full lg:w-[40%] 2xl:w-[40%] rounded-2xl shadow-lg overflow-hidden border border-gray-100">
                            <div className="bg-[#18998A] text-white text-center py-5 px-6">
                                ...
                                <h2 className="text-2xl 2xl:text-3xl font-normal mt-3">
                                    Register Now! <span className="font-semibold">For Free webinar</span>
                                </h2>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="bg-white px-6 py-8 space-y-6">
                                ...
                                <div className="flex flex-col sm:flex-row gap-4">
                                    <div className="relative w-full">
                                        <label className="block text-sm font-medium text-[#000000] mb-2.5">Name<span className="text-red-500">*</span></label>
                                        <input
                                            type="text"
                                    ...
                                    <div className="relative w-full">
                                        <label className="block text-sm font-medium text-[#000000] mb-2.5">E-mail<span className="text-red-500">*</span></label>
                                        <input
                                            type="email"
                                ...
                                <div className="relative">
                                    <label className="block text-sm font-medium text-[#000000] mb-2.5">Contact Number</label>
                                    <input
                                        type="text"
                                ...
                                {/* Company */}
                                <div className="relative">
                                    <label className="block text-sm font-medium text-[#000000] mb-2.5">Company<span className="text-red-500">*</span></label>
                                    <input
                                        type="text"
                                ...
                                {/* Profession */}
                                <div>
                                    <label className="block text-sm font-medium text-[#000000] mb-2.5">Profession</label>
                                    <div className="flex max-sm:flex-col sm:items-center justify-between pr-4 gap-2 sm:gap-6 text-sm">
                                        <label className="flex items-center gap-2">
                                            <input type="radio" name="profession" className="accent-[#18998A]" />
                        ...
                        <div id='speakers' className="max-lg:rounded-[50px] max-lg:mt-16 lg:rounded-l-[75px] shadow-webinarSpeaker px-12 2xl:px-20 3xl:px-32 py-10 text-center bg-white">
                            ...
                            <div className="flex flex-col sm:flex-row justify-center items-center gap-10">
                                ...
                                <div className="flex flex-col items-center">
                                    ...
                                    <div className="mt-2 text-sm 3xl:text-base font-medium text-gray-800">Looker Studio Expert.</div>
                                    <p className="text-xs 3xl:text-sm text-[#656565] max-w-[230px] 3xl:max-w-[260px] mt-1 text-center">
                                        He specializes in data storytelling and visualization techniques.
                                    </p>
                                </div>
                ...
                <section
                    ...
                    style={{
                        background: 'linear-gradient(180deg, rgba(110, 216, 212, 0.8) 0%, rgba(255, 255, 255, 0.8) 100%)',
                    }}
                >
                    <div className="w-full px-[3%] flex flex-col lg:flex-row justify-between items-center gap-12">
                        ...
                        <div className="flex flex-col 2xl:w-[35%] 3xl:ml-16 text-center lg:text-left">
                            ...
                            <div className="flex max-md:flex-wrap justify-center lg:justify-start gap-8 mb-8">
                                {[
                                    { src: 'https://storage.googleapis.com/website-bucket-uploads/popup/Looker_Studio_Blue_Logo%203.png', label: 'Looker Studio' },
                                    { src: 'https://storage.googleapis.com/website-bucket-uploads/popup/Data%20Visualisation.png', label: 'Data Visualization' },
                                    { src: 'https://storage.googleapis.com/website-bucket-uploads/popup/Dashboarding.png', label: 'Dashboarding' },
                                ].map((item, index) => (
                                    <div key={index} className="flex flex-col items-center">
                                        ...
                                        <div className="relative">
                                            ...
                                            <div className="w-[103px] 2xl:w-32 h-[103px] 2xl:h-32 rounded-full bg-white border border-[#C0C0C080] flex flex-col items-center justify-center relative z-10">
                                                ...
                                                <div className="text-[10px] 2xl:text-xs text-center text-[#333] mt-1 2xl:mt-2">{item.label}</div>
                                            </div>
                                        </div>
                                    </div>
                                ))}
                            ...
                            <div className="flex flex-col sm:flex-row items-center gap-4">
                                <div className="flex items-center gap-1">
                                    <div className="w-8 h-8 rounded-full bg-white border-2 border-white -ml-0">
                                        <img src="https://storage.googleapis.com/website-bucket-uploads/popup/image%20(23).png" alt="Viewer 1" className="w-full h-full rounded-full" />
                                    </div>
                                    <div className="w-8 h-8 rounded-full bg-white border-2 border-white -ml-4">
                                        <img src="https://storage.googleapis.com/website-bucket-uploads/popup/image%20(24).png" alt="Viewer 2" className="w-full h-full rounded-full" />
                                    </div>
                                    <div className="w-8 h-8 rounded-full bg-white border-2 border-white -ml-4">
                                        <img src="https://storage.googleapis.com/website-bucket-uploads/popup/image%20(25).png" alt="Viewer 3" className="w-full h-full rounded-full" />
                                    </div>
                                    ...
                                    <div className='text-xs 2xl:text-sm 3xl:text-base font-semibold'>Registered Viewers</div>
                                </div>
                                <button onClick={scrolling} className="bg-[#0C7077] hover:bg-[#095e64] flex gap-2 items-center justify-center transition text-white font-semibold px-3.5 2xl:px-6 py-1.5 2xl:py-2 rounded-md shadow-md text-xs 2xl:text-base">
                                    REGISTER NOW
                                    <img src='https://storage.googleapis.com/website-bucket-uploads/popup/Right%20Arrow%20(1).png' alt=''
                                        className='w-5' />
                                </button>
                ...
                <section className="my-20 px-[5%] bg-white">
                    <div className="w-full mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 text-center">
                        ...
                        <div className="relative rounded-xl text-white max-lg:h-64 flex flex-col justify-center items-center font-semibold text-lg">
                            ...
                            <div className="relative z-10">
                                <div className="text-2xl 2xl:text-3xl font-bold">245+ <br />Clients</div>
                                <div className="text-base lg:text-lg font-normal mt-5">Across the globe</div>
                            </div>
                        </div>
                        ...
                        <div className="relative rounded-xl text-white max-lg:h-64 flex flex-col justify-center items-center font-semibold text-lg">
                            ...
                            />
                            <div className="relative z-10">
                                <div className="text-2xl 2xl:text-3xl font-bold">465+ <br />Dashboards</div>
                                <div className="text-base lg:text-lg font-normal mt-5">Across platforms</div>
                            </div>
                        </div>
                        ...
                        <div className="relative rounded-xl text-white max-lg:h-64 flex flex-col justify-center items-center font-semibold text-lg">
                            ...
                            />
                            <div className="relative z-10">
                                <div className="text-2xl 2xl:text-3xl font-bold">37+ <br />Platforms</div>
                                <div className="text-base lg:text-lg font-normal mt-5">Including Ads and CRM</div>
                            </div>
                        </div>
                        ...
                        <div className="relative rounded-xl text-white max-lg:h-64 flex flex-col justify-center items-center font-semibold text-lg">
                            ...
                            />
                            <div className="relative z-10">
                                <div className="text-2xl 2xl:text-3xl font-bold">30+ <br />Professionals</div>
                                <div className="text-base lg:text-lg font-normal mt-5">Experts in various fields</div>
                            </div>
                        </div>
...
{/* <header className="relative z-20 flex justify-between items-center px-[5%] py-[22px]">
                        <div className="w-[30%]">
                            <img
                                alt="logo"
                                className="w-[150px] lg:w-[180px] 2xl:w-[220px]"
                                src="https://storage.googleapis.com/website-bucket-uploads/static/logo.png"
                            />
                        </div>
                        <div className="w-[70%] flex justify-between pr-40 items-center">
                            <div className="w-[80%] flex justify-around items-center text-[#464646] text-sm 2xl:text-[15px] font-bold">
                                <div>Webinar Date & Time</div>
...
//             {/* MAIN CONTENT */}
//             <div className="relative z-20 flex flex-col lg:flex-row items-end justify-between px-[5%] grow pt-10 pb-32">
//                 {/* LEFT TEXT BLOCK */}
...
//                             alt=""
//                         />
//                         <div className="absolute top-2 left-3 text-[33px] font-semibold">
//                             WEBINAR on
//                         </div>
//                     </div>
//                     <div className="text-[#1C1C1C] text-[40px] sm:text-[50px] font-semibold leading-10 pt-8 pb-6">
//                         Data <span className="font-satisfy">Storytelling</span> with
//                     </div>
//                     <div className="text-[42px] sm:text-[65px] text-[#4186F4] font-poppins font-semibold leading-10">
//                         Looker Studio
//                     </div>
//                     <div className="text-[#464646] text-xl sm:text-2xl font-normal pt-10">
//                         Join the live session with experts from AnalyticsLiv.
//                         <br />
//                         We share expert strategies on transforming raw data into compelling stories using Looker Studio.
//                     </div>

//                     <div className='shadow-webinarTime flex px-[25px] py-[20px] mt-11 justify-evenly items-start rounded-[17px] border border-[#B9B9B999]'>
//                         <div className='flex flex-col items-center gap-3'>
//                             <img src='https://storage.googleapis.com/website-bucket-uploads/popup/Date.png' alt='' />
//                             <div className='text-xs text-center'>24 July 2025</div>
//                         </div>
...
//                             <div className='text-xs text-center'>Free</div>
//                         </div>
//                         <button className='bg-[#0C7077] shadow-teamShadow px-4 py-2 my-4 flex justify-center items-center rounded-[10px] text-white'>
//                             <div className='text-base font-bold'>REGISER NOW</div>
//                             <img src='https://storage.googleapis.com/website-bucket-uploads/popup/Right%20Arrow.png' alt='' />
//                         </button>
//                     </div>

//                     <div>
//                         <img src='https://storage.googleapis.com/website-bucket-uploads/popup/Layer_1.png' alt='' />
//                     </div>
...
//                     <img src='https://storage.googleapis.com/website-bucket-uploads/home_page/Homepage_Img/Rectangle%204.png' alt='' className='absolute top-0 z-10 w-full' />
//                     <header className='relative z-20 flex justify-between items-center px-[5%] py-[22px]'>
//                         <div className='w-[30%]'>
//                             <img alt="logo" className="w-[150px] lg:w-[180px] 2xl:w-[220px]" src="https://storage.googleapis.com/website-bucket-uploads/static/logo.png" />
//                         </div>
//                         <div className='w-[70%] flex justify-between pr-40 items-center'>
//                             <div className='w-[80%] flex justify-around items-center text-[#464646] text-sm 2xl:text-[15px] font-bold'>
//                                 <div>Webinar Date & Time</div>
...
//                         </div>
//                     </header>
//                     <section className='relative z-20 flex items-center justify-between px-[5%]'>
//                         <div className='w-[70%]'>
//                             <div className='relative'>
//                                 <img src='https://storage.googleapis.com/website-bucket-uploads/popup/OBJECTS.png' alt='' className='relative' />
//                                 <div className='absolute top-2 left-3 text-[33px] font-semibold'>WEBINAR on</div>
//                             </div>
//                             <div className="text-[#1C1C1C] text-[50px] font-semibold">
//                                 Data <span className='font-satisfy'>Storytelling</span> with
//                             </div>
//                             <div className="text-[55px] text-[#4186F4] font-poppins font-semibold">Looker Studio</div>
//                             <div className='text-[#464646] text-2xl font-normal'>
//                                 Join the live session with experts from AnalyticsLiv.<br></br>
//                                 We share expert strategies on transforming raw data into compelling stories using Looker Studio.
//                             </div>
//                         </div>
//                         <div className=''>
//                             <div className='relative'>
//                                 <img src='https://storage.googleapis.com/website-bucket-uploads/popup/header-pic.png' alt=''
//                                     className='' />
//                                 <img src='https://storage.googleapis.com/website-bucket-uploads/popup/Group%2014.png' alt=''
...
{/* <div className="rounded-2xl shadow-lg overflow-hidden border border-gray-100">
                            <div className="bg-[#18998A] text-white text-center py-5 px-6">
                                <p className="text-sm">Welcome to <span className="font-semibold">AnalyticsLiv</span></p>
                                <h2 className="text-lg sm:text-xl font-semibold mt-1">
                                    Register Now! <span className="font-bold">For Free webinar</span>
                                </h2>
                            </div>

                            <form className="bg-white px-6 py-8 space-y-4">
                                <div className="flex flex-col sm:flex-row gap-4">
                                    <div className="relative w-full">
                                        <input
                                            type="text"
                                            placeholder="Enter your name"
                                            className="w-full border border-gray-300 rounded-md py-2 px-3 pr-10 text-sm"
                                        />
                                        <img src="https://storage.googleapis.com/website-bucket-uploads/popup/Group%2041.png" alt="icon" className="w-5 h-5 absolute top-1/2 right-3 transform -translate-y-1/2" />
                                    </div>
                                    <div className="relative w-full">
                                        <input
                                            type="email"
                                            ...
                                            className="w-full border border-gray-300 rounded-md py-2 px-3 pr-10 text-sm"
                                        />
                                        <img src="https://storage.googleapis.com/website-bucket-uploads/popup/Group%20(3).png" alt="icon" className="w-5 h-5 absolute top-1/2 right-3 transform -translate-y-1/2" />
                                    </div>
                                </div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full border border-gray-300 rounded-md py-2 px-3 pr-10 text-sm"
                                    />
                                    <img src="https://storage.googleapis.com/website-bucket-uploads/popup/Vector%20(10).png" alt="icon" className="w-5 h-5 absolute top-1/2 right-3 transform -translate-y-1/2" />
                                </div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full border border-gray-300 rounded-md py-2 px-3 pr-10 text-sm"
                                    />
                                    <img src="https://storage.googleapis.com/website-bucket-uploads/popup/Group%203984.png" alt="icon" className="w-5 h-5 absolute top-1/2 right-3 transform -translate-y-1/2" />
                                </div>
                                ...
                                <button
                                    type="submit"
                                    className="w-full bg-[#18998A] hover:bg-[#127f74] text-white font-semibold py-3 rounded-md mt-2 text-base"
                                >
                                    JOIN FREE →
                                </button>
                            </form>
