...
export default function IrecSummit({ brandsdata }) {
    ...
    `}</style>
                    <div className="flex-grow flex justify-between items-center relative max-sm:px-2 sm:pr-5 2xl:px-10">
                        <div className="text-left max-md:pt-5 flex-1 sm:pl-[5dvw] md:px-[4dvw] lg:px-0 lg:pl-[13dvw] xl:pl-[17dvw] 2xl:pt-0 xl:pt-[100px] 2xl:pl-[11dvw]">
                            <div className="text-2xl md:text-3xl 2xl:text-4xl md:pt-4 lg:pt-14 xl:mt-[-100px] 2xl:pt-32 font-black text-white mb-6 max-sm:mb-5 font-lato max-lg:text-center">
                                Join Us at IReC 2025
                                <br></br>
                                Reimagining & Redefining Retail &
                                E-Commerce
                            </div>
                            <div className="text-base text-white mb-12 sm:mb-8 xl:mb-5 font-lato max-lg:text-center">
                                Transform your brand with data-driven strategies, cutting-edge analytics, and performance-focused marketing. Meet AnalyticsLiv at the forefront of innovation!
                            </div>
            ...
            <section className="flex lg:relative justify-center lg:justify-end max-lg:flex-col xl:gap-36 xl:px-28">
                <div className="lg:absolute z-20 left-[16dvw] 2xl:left-[13dvw] top-[-150px] 2xl:top-[-200px]">
                    {showWaiting ? (
                        ...
                        <div
                            className="webinarForm max-md:mx-4 max-lg:mx-28 overflow-auto z-20 h-[400px] md:h-[475px] lg:h-[500px] xl:h-[480px] 2xl:h-[450px] 
                  md:my-10 max-md:mt-4 xl:top-[400px] 2xl:top-[550px] lg:w-[350px] xl:w-[370px] 2xl:w-[420px] border-[5px] rounded-lg border-[#FFFFFF] 
                  shadow-[0_5px_10px_0_rgba(0,0,0,0.25)] text-center flex flex-col justify-around items-center px-3 md:px-4 py-2 md:py-5 bg-white"
                        >
                            <h2 className="md:text-xl text-[#3C292A]">
                                Thank you for sharing the details, We look forward to our meeting in Bengaluru!
                            </h2>
                        ...
                        <div
                            className="webinarForm max-md:mx-4 max-lg:mx-28 overflow-auto z-20 h-[400px] md:h-[475px] lg:h-[500px] xl:h-[480px] 2xl:h-[530px] 
            md:my-10 max-md:mt-4 xl:top-[400px] 2xl:top-[550px] lg:w-[350px] xl:w-[370px] 2xl:w-[420px] border-[5px] rounded-lg border-[#FFFFFF] 
            shadow-[0_5px_10px_0_rgba(0,0,0,0.25)] text-center flex flex-col justify-around items-center px-3 md:px-4 xl:px-7 py-2 md:py-3 bg-white"
                        >
                            ...
                            <div className="text-sm md:text-xl 2xl:text-2xl font-normal text-[#3C292A]">
                                Schedule a Meet at Our Booth
                            </div>

                            <form
                                className="flex flex-col gap-3.5 md:gap-6 lg:gap-6 2xl:gap-8 w-[90%] md:w-[90%]"
                ...
                <div className="w-full lg:w-[50%] xl:w-[50%] 2xl:w-[55%] pt-14 sm:pt-5 lg:pb-[120px] md:pt-12">
                    <div className="text-[35px] font-bold text-[#3C292A] pb-2 lg:pb-4 xl:pb-14 xl:font-extrabold text-center ">
                    ...
                    {/* desktop view */}
                    <div className="max-md:w-[90%] max-md:mx-auto max-md:mt-8 max-md:mb-8 lg:border-b shadow-customShadow rounded-lg md:rounded-[40px] pt-10 lg:border-b-[#BBBBBB] lg:pb-5 xl:pb-10 2xl:pb-14 flex max-sm:flex-col max-sm:gap-14 items-center justify-around">
                        <div className="flex flex-col w-[33%]">
                            <img
                                src="https://storage.googleapis.com/website-bucket-uploads/clients/calendar%20(12).png"
                                alt=""
                                className="pb-3 w-8 mx-auto"
                            />
                            <div className="text-base font-black text-center text-[#3C292A] pb-2">
                                Date
                            </div>
                        ...
                        <div className="flex flex-col w-[33%]">
                            <img
                                src="https://storage.googleapis.com/website-bucket-uploads/clients/location%20(11).png"
                                alt=""
                                className="pb-3 w-8 mx-auto"
                            />
                            <div className="text-base font-black text-center text-[#3C292A] pb-2">
                            ...
                            <div className="text-sm font-normal text-center">
                                Hotel Sheraton Grand<br></br>
                                Brigade, bengaluru
                            </div>
                        </div>
                        <div className="flex flex-col w-[33%]">
                            <img
                                src="https://storage.googleapis.com/website-bucket-uploads/clients/booth.png"
                            ...
                            <div className="text-sm font-normal text-center">A10</div>
                        </div>
                    </div>
            ...
            <section className='xl:pt-0 px-4 xl:px-16 pb-8 md:pb-12'>
                ...
                <div className='pt-12 flex justify-center items-center'>
                    <img src='https://storage.googleapis.com/website-bucket-uploads/home_page/Images_and_Icons/AnalyticsLiv_Client_Map.png' alt='Trusted By Worldwide - Analyticsliv Clients' className='h-full w-full xl:w-[1000px] 2xl:w-[85%]' />
                </div>
            </section>
            ...
            <section className="flex max-xl:flex-col bg-[#F5FDFF] md:pt-7 xl:pt-0 md:mt-16 xl:mt-0">
                <section className="w-full xl:px-20">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-5 max-md:gap-8 md:gap-16 max-sm:grid-cols-1 justify-around md:px-10 2xl:px-24 pb-8 xl:pb-20">
                        <div className="flex flex-col items-center max-md:gap-4 md:gap-10">
                            <img src="https://storage.googleapis.com/website-bucket-uploads/home_page/Images_and_Icons/Group%2035.png" className="h-20 w-20 lg:h-32 lg:w-32" alt="privacy" />
                            <div className="text-sm font-medium text-center">
                                Google Analytics 4 (GA4) Setup
                            </div>
                        </div>
                        <div className="flex flex-col items-center max-md:gap-4 md:gap-10">
                            <img src="https://storage.googleapis.com/website-bucket-uploads/home_page/Images_and_Icons/Group%2035%20(1).png" className="h-20 w-20 lg:h-32 lg:w-32" alt="privacy" />
                            <div className="text-sm font-medium text-center">
                                Tag Management with
                                GTM
                            </div>
                        ...
                        <div className="flex flex-col items-center max-md:gap-4 md:gap-10">
                            <img
                                src="https://storage.googleapis.com/website-bucket-uploads/home_page/Images_and_Icons/Group%2035%20(2).png"
                        ...
                        <div className="flex flex-col items-center max-md:gap-4 md:gap-10">
                            <img src="https://storage.googleapis.com/website-bucket-uploads/home_page/Images_and_Icons/Group%2035%20(3).png" className="h-20 w-20 lg:h-32 lg:w-32" alt="settings" />
                            <div className="text-sm font-medium text-center">
                                Conversion Rate Optimization (CRO)
                            </div>
                        </div>
                        <div className="flex flex-col items-center max-md:gap-4 md:gap-10">
                            <img src="https://storage.googleapis.com/website-bucket-uploads/home_page/Images_and_Icons/Group%2035%20(4).png" className="h-20 w-20 lg:h-32 lg:w-32" alt="settings" />
                            <div className="text-sm font-medium text-center">
                                Advanced AI
                                Solutions
                            </div>
            ...
            >
                <div className="text-[12px] max-sm:w-[60%] max-lg:w-[77%] md:text-xl font-semibold text-white">
                    Ready to Power Up Your Retail Game?
                </div>
                <a
                    onClick={scrolling1}
                    target="_blank"
            ...
            <section className=" w-full h-full flex justify-center pb-8">
                <img
                    onClick={scrolling1}
                    src="https://storage.googleapis.com/website-bucket-uploads/home_page/Images_and_Icons/IREC%20Banner%20(1).png"
                    alt="footer-banner"
