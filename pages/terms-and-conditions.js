    ...
    return (<>
        ...
        <div className="page_title bg-[#4b82f9] text-white mb-10 relative">
            <div className='p-10'>
                ...
                <h1 className='text-[38px] leading-[38px] font-bold'>Terms And Conditions</h1>
            </div>

        </div>
        <div className="p-10 pt-0 text-base font-normal leading-7 text-[#243238]">
            <div className="text-[#243238] text-base leading-[24px] font-normal mb-[15px]">
                <strong>Overview</strong>
            </div>
            <p className="text-sm">This website is operated by AnalyticsLiv Digital LLP. Throughout the site, the terms “we”, “us” and “our” refer to AnalyticsLiv Digital LLP. AnalyticsLiv Digital LLP offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.</p>

            <p className="text-sm">By visiting our site and/or purchasing something from us, you engage in our “Service” and agree to be bound by the following terms and conditions (“Terms of Service”, “Terms”), including those additional terms and conditions and policies referenced herein and/or available by hyperlink. These Terms of Service apply to all users of the site, including without limitation users who are browsers, vendors, customers, merchants, and/or contributors of content.</p>

            <p className="text-sm">Please read these Terms of Service carefully before accessing or using our website. By accessing or using any part of the site, you agree to be bound by these Terms of Service. If you do not agree to all the terms and conditions of this agreement, then you may not access the website or use any services. If these Terms of Service are considered an offer, acceptance is expressly limited to these Terms of Service.</p>
            ...
            <p className="text-sm">
                ...
                without consulting primary, more accurate, more complete or more timely sources of information. Any reliance on the material on this site is at your own risk.
            </p>
            ...
            <p className="text-sm">
                Third-party links, iFrames on this site may direct you to third-party websites that are not affiliated with us. We are not
            ...
            <p className="text-sm">
                You agree to indemnify, defend and hold harmless AnalyticsLiv Digital LLP and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.
            </p>
            ...
            <p className="text-sm">
                These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws of India and the jurisdiction of Jaipur, Rajasthan.
            </p>
