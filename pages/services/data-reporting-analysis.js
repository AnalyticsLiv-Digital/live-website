    ...
    <section class="bg-analyticssection relative">
        ...
        <div class="md:mt-4 px-4 md:px-20 pt-8 md:pt-11 md:pb-16 pb-8">
            ...
            <p class="text-analyticsheading text-[30px] font-medium mt-1.5">Our streamlined process activates your data in just a
                ...
                <div>
        <Slider {...settings}>
        <div class="max-w-sm  z-10 text-center flex bg-white rounded-md border border-solid border-analyticsheading">
                                    ...
                                    <div
                                        class="max-w-sm z-10 text-center flex bg-white rounded-md border border-solid border-analyticsheading">
                                        <div class="p-6 text-start h-80">
                                            <div class="text-center flex items-center"><img
