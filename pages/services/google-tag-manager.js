...
const google_tag_manager = () => {
  return (
    <>
    <section class="banner relative h-full py-20" style={{backgroundImage: 'url(https://storage.googleapis.com/website-bucket-uploads/static/gtm_sp/Shape-banner.png)', backgroundRepeat: 'no-repeat', backgroundSize: 'cover'}}>
        <div class="max-w-screen-xl mx-auto">
            <div class="inner-banner text-center md:mx-20 mt-28 px-4 md:px-20 pt-4 pb-4 md:pb-16">
                <h1 class="flex items-center justify-center mb-14">
                    <img src="https://storage.googleapis.com/website-bucket-uploads/static/gtm_sp/GTM_Logo-removebg-preview 2.png" alt="logo"/>
                    <span class="text-banner md:text-5xl text-[50px] lg:text-[59px] font-bold">Google Tag Manager</span>
                </h1>
                <div class="relative">
                    <p class="text-black md:text-3xl lg:text-[37px] text-2xl font-semibold">Enhance Your Digital
                        Strategy
                ...
                <div class="bottom-audit mt-8">
                    <div class="services grid items-center md:grid-cols-3 lg:grid-cols-6 py-7 md:gap-8 gap-16">
                        ...
                        <div class="item-2 text-center cursor-pointer">
                            ...
                            <h6 class="text-blue-500 text-base font-semibold pt-5">Errors or bugs
                                reported</h6>
                        </div>
