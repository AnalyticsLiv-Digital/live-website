...
const Seo = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setFormData({ fullName: "", email: "", company: "", website: "", message: "", pageSource: "Seo", });
      } else {
  ...
  const content = [
    { question: 'How long until results?', answer: 'Most SEO programs show traction in 3–6 months, with compounding growth thereafter.' },
    { question: 'What tools do you use?', answer: 'Google Search Console, GA4, Screaming Frog, Ahrefs, Looker Studio, and more.' },
    { question: 'Do you provide content as well?', answer: 'Yes, from content briefs and outlines to full copy optimization.' },
    { question: 'How do you measure ROI?', answer: 'Organic traffic growth, conversions, keyword visibility, and assisted revenue.' }
  ]

  return (
    <>
      <MetaSchemaOg
        url="https://analyticsliv.com/services/seo"
        title="Search Engine Optimization (SEO) Services | AnalyticsLiv"
        description="Enterprise SEO services engineered for growth. From technical SEO to authority building, we drive traffic, rankings, and revenue with proven strategies and measurable outcomes."
        twitterTitle="Search Engine Optimization (SEO) Services | AnalyticsLiv"
        twitterDescription="Enterprise SEO services engineered for growth. From technical SEO to authority building, we drive traffic, rankings, and revenue with proven strategies and measurable outcomes."
        faqData={content}
      />
              ...
              <div class="grid items-center gap-8 md:grid-cols-2">
                ...
                <div class="rounded-3xl border border-white/20 bg-white/5 p-6">
                  <form onSubmit={handleSubmit} action="#" method="post" className="grid gap-3 md:grid-cols-2">
                    ...
                    <label className="text-sm md:col-span-1" for="website">Website
                      <input value={formData.website} onChange={handleChange} id="website" name="website" placeholder="https://" className="mt-1 w-full rounded-xl border border-white/20 bg-white/10 px-3 py-2 text-white placeholder:text-white/60 focus:outline-none" />
                    </label>
                    <label className="text-sm md:col-span-2" for="message">Goals & pain points
                      <textarea value={formData.message} onChange={handleChange} id="message" name="message" rows="4" placeholder="Where do you need SEO lift?" className="mt-1 w-full rounded-xl border border-white/20 bg-white/10 px-3 py-2 text-white placeholder:text-white/60 focus:outline-none"></textarea>
                    </label>
