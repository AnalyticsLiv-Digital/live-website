...
const index = ({ leadDat }) => {
    const leadsData = leadDat.ecommerce;
    console.log("object contact----------------", leadsData)
                                    ...
                                    {leadsData &&
                                        leadsData?.map((contact, key) => (
                                            ...
                                            >
                                                ...
                                                <td className="py-4 px-6">{contact.website}</td>
...
export async function getServerSideProps(context) {
    const res = await fetch(`${process.env.domain}/api/admin/leads?type=ecommerce`);
