...
const index = (casestudy) => {
    ...
    const initialValues = {description:casestudydata.description, open:casestudydata.open,id:casestudydata.id, coverimage: casestudydata.coverimage, description:casestudydata.description, title: casestudydata.title, slug: casestudydata.slug, author: casestudydata.author, publishdate: casestudydata.publishdate, active: casestudydata.active, sequence: casestudydata.sequence, filename:casestudydata.filename, content1:casestudydata.content[0].description,heading1:casestudydata.content[0].heading,heading2:casestudydata.content[1].heading, content2:casestudydata.content[1].description, heading3:casestudydata.content[2].heading, content3:casestudydata.content[2].description, heading4:casestudydata.content[3].heading, content4:casestudydata.content[3].description, heading5:casestudydata.content[4]?casestudydata.content[4].heading:'', content5:casestudydata.content[4]?casestudydata.content[4].description:''};
  ...
  return (
    <div>
        ...
        Id - <input className="px-2.5 pb-2.5 pt-5 w-1/2 text-sm text-gray-900 bg-transparent  border-0 border-b-2 border-slate-500 appearance-none  focus:outline-none focus:ring-0 focus:border-cyan-500 peer" type="text" name="id" value={formValues.id} onChange={handleChange} /><br/>
            ...
            <input placeholder='Heading 5' className="px-2.5 pb-2.5 pt-5 w-1/2 text-sm text-gray-900 bg-transparent  border-0 border-b-2 border-slate-500 appearance-none  focus:outline-none focus:ring-0 focus:border-cyan-500 peer" type="text" name="heading4" value={formValues.heading5} onChange={handleChange} /><br/>
            <input placeholder="Content 5" className="px-2.5 pb-2.5 pt-5 w-1/2 text-sm text-gray-900 bg-transparent  border-0 border-b-2 border-slate-500 appearance-none  focus:outline-none focus:ring-0 focus:border-cyan-500 peer" type="text" name="content4" value={formValues.content5} onChange={handleChange} /><br/><br/>
