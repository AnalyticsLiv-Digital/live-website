    ...
    <>
      ...
      <div>
        <div className="relative lg:mb-32">
          ...
          <img
            src="https://storage.googleapis.com/website-bucket-uploads/static/marketing.jpg"
            className="absolute h-32 lg:h-48 lg:top-2 lg:right-56 rounded-lg"
          />
          <div className="relative lg:border-2 lg:border-slate-900 lg:flex rounded-lg backdrop-blur-xl bg-white h-20 lg:h-36 w-4/5 md:w-3/5 lg:w-1/3 p-6 lg:top-20 top-10 text-left mx-auto mb-6">
            <div className="lg:pt-8 ">
              <h2 className="lg:text-2xl text-slate-700 font-semibold whitespace-relaxed ">
                B L O G S.
              </h2>
        ...
        <section className="">
          <div className="text-center bg-cyan-50 md:bg-white pt-7 lg:pt-16 z-2">
            <h1 className="text-center mb-4 text-lg font-medium tracking-wide text-cyan-800 text-lg">
          ...
          <div className="text-center pb-8 z-2">
            <form method="get" action="/blogs/search">
              <input
                ...
                type="search"
                placeholder="Search"
                className="bg-stone-100 w-3/5 lg:w-2/5 rounded-l-full border border-cyan-500 py-2 pl-9 focus:outline-none focus:caret-gray-400"
              />
              <input
                type="submit"
                value="Search"
                id="Search"
                className="bg-cyan-500 text-white rounded-r-full border border-cyan-500 py-2 px-4 -ml-2 focus:outline-none"
              />
            </form>
          </div>
        </section>
        ...
        <section className="relative">
          <div className="relative lg:flex flex-row  w-full">
            <div className="hidden bg-gray-50  h-100% w-1/2 my-8 p-4 space-y-4 mx-4">
              ...
              <div className="space-y-2 text-sm text-left pl-10">
                <h2 className="text-base text-sm text-slate-800 font-medium pl-5">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="absolute w-6 left-12 fill-purple-900"
                    preserveAspectRatio="xMidYMid meet"
                    viewBox="0 0 24 24"
                  >
            ...
            <div
              className="bg-cover py-8 lg:py-16 bg-scroll"
              style={{
                backgroundImage: `url("https://img.freepik.com/free-vector/white-abstract-background_23-2148810113.jpg?t=st=1671082381~exp=1671082981~hmac=659665427411ee225ef245d30444c4a2513e113dcfebb8e1dabf685749e40e1e")`,
              }}
            >
          ...
          <nav
            className="absolute w-full bottom-0 m-auto inline-flex -space-x-px rounded-md shadow-sm"
            aria-label="Pagination"
          >
            <div className="m-auto py-4"></div>
          </nav>
        </section>
      </div>
    </>
...
export async function getServerSideProps(context) {
  ...
  const res = await fetch(
    `${process.env.domain}/api/blogsearch?search=${context.query.s}`
  );
