...
const slug = ()=>{
    ...
    return (<>
    <Head>
    <title>AnalyticsLiv - </title>
  </Head>
  <ScrollProgress/>
    <section> 
        <div className='md:flex md:flex-row md:flex-row-reverse'>
        <div className="lg:sticky top-0 lg:w-1/5 space-y-4">
            <div className="space-y-6 w-full mx-2">
                <h3 className="w-full text-slate-700 pt-2 px-3 font-bold tracking-wider text-center">Similar Posts</h3>
