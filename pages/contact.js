                    ...
                    <div className="relative overflow-hidden lg:w-4/5 lg:p-8 pt-2 rounded-lg mx-2 lg:mx-auto bg-white">
                        ...
                        <div className="relative mx-2 lg:flex">
                            <div data-aos="fade-up" data-aos-once="true" className="relative md:h-screen overflow-hidden lg:w-1/3 rounded-lg bg-slate-900 space-y-9 px-4 pt-12 pb-20 align-middle text-white">
                                ...
                                <Link href="https://m.facebook.com/100070503960704/"><svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24" className="w-8 inline mx-1 fill-current hover:fill-[#1877f2]">
                <path  d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-2c-.55 0-1 .45-1 1v2h3v3h-3v6.95c5.05-.5 9-4.76 9-9.95z"/>
            </svg>
            </Link>
                                    <Link href="https://in.linkedin.com/company/analytics-liv-digital"><svg xmlns="http://www.w3.org/2000/svg" className="w-8 inline fill-current hover:fill-[#0077b5]" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                                    ...
                                    <Link href="https://www.youtube.com/channel/UCSU9utLB2PDe4VcXiI5kMFw"><svg xmlns="http://www.w3.org/2000/svg" className="w-8 inline fill-current hover:fill-[#ff0000]" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
