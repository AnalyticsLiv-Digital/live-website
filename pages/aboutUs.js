                            ...
                            {timelineData?.map((item, index) => (
                                ...
                                >
                                    ...
                                    <div className='flex flex-col justify-center items-center'>
                                        ...
                                        {/* Dot */}
                                        <div className={`w-3 h-3 rounded-full mt-1 mb-2 ${hoveredYear === index ? `bg-[${item.color}] ` : 'bg-black'}`}></div>
                                        {console.log("object",item.color, hoveredYear, index)}
                                    </div>

                                    {/* Title */}
                                    <div className={`${hoveredYear === index ? 'shadow-teamShadow' : 'shadow-none'} px-8 py-4 flex flex-col items-center justify-around h-40 bg-white hover:shadow-customShadow`}>
                                    ...
                                    {hoveredYear === index && (
                                        <div className='absolute top-[60px] h-52 shadow-cardShadow left-1/2 transform -translate-x-1/2 bg-white rounded-lg w-56 z-30'>
                                            ...
                                            <div className="p-4 flex flex-col justify-around items-center px-3 py-3">
                                                <img
                                                    src={item?.logo}
                                                    alt={item.title}
