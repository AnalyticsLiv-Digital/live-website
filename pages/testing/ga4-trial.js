...
export default function Ga42({ brandsdata }) {
        ...
        <>
            ...
            <div>
                ...
                <section className='flex max-md:flex-col justify-between items-center max-md:text-center px-[4%] 3xl:px-[6%] max-md:pt-12 md:pt-3 lg:mt-6 lg:mb-3 3xl:mb-6 gap-10'>
                    <div className='md:w-[70%] lg:w-[50%] 2xl:w-[40%] 3xl:w-[52%] flex flex-col gap-7 md:gap-10'>
                        ...
                        <div className='flex max-md:items-center lg:items-center gap-3 lg:gap-11 max-lg:flex-col'>
                            ...
                            <button onClick={() => setIsVideoOpen(true)} className='flex items-center gap-3'>
                                ...
                                <div className='text-lg font-bold text-[#2563EB]'>Client Success</div>
                            </button>
                            {isVideoOpen && (
                    ...
                    <div>
                        <img src='https://storage.googleapis.com/website-bucket-uploads/ua-and-ga4/GA4_Right_Image.png' alt='' />
                    </div>
                </section>
                                ...
                                {cardsData?.map((card, index) => (
                                    <div>
                                        <div className="max-w-[320px] xl:max-w-[349px] 2xl:max-w-[369px] flex flex-col gap-3">
                                            ...
                                            <div className="text-[#0F172A] text-base xl:text-xl 2xl:text-[22px] font-bold leading-7">{card?.title}</div>
                                            <div className="text-[#0F172A] text-xs xl:text-sm 2xl:text-base">{card?.description}</div>
                                        </div>
                                    </div>
                                ))}
                            </Slider>
                        ...
                        <div className="lg:hidden md:mt-2 py-8 carousel-custom overflow-hidden">
                            <Slider {...servieSettings}>
                                <div className='border h-[170px] w-[180px] xl:w-[205px] px-[10px] xl:px-[14px] py-[25px] xl:py-[35px] border-[#2563EB] hover:shadow-ga4Show rounded-lg flex flex-col justify-between items-center gap-[27px]'>
                                    <img src='https://storage.googleapis.com/website-bucket-uploads/ua-and-ga4/settings%20(7).png' alt='' className='mx-auto pb-5' />
                                    <div className='text-[#0F172A] text-xs text-center'>GA4 Setup, Reporting & Debugging</div>
                                </div>
                                <div className='border h-[170px] w-[180px] xl:w-[205px] px-[10px] xl:px-[14px] py-[25px] xl:py-[35px] border-[#2563EB] hover:shadow-ga4Show rounded-lg flex flex-col justify-between items-center gap-[27px]'>
                                    <img src='https://storage.googleapis.com/website-bucket-uploads/ua-and-ga4/dashboard%20(13).png' alt='' className='mx-auto pb-5' />
                                    <div className='text-[#0F172A] text-xs text-center'>Custom Dashboards via Looker Studio & BigQuery</div>
                                </div>
                                <div className='border h-[170px] w-[180px] xl:w-[205px] px-[10px] xl:px-[14px] py-[25px] xl:py-[35px] border-[#2563EB] hover:shadow-ga4Show rounded-lg flex flex-col justify-between items-center gap-[27px]'>
                                    <img src='https://storage.googleapis.com/website-bucket-uploads/ua-and-ga4/customer-segment%20(2).png' alt='' className='mx-auto pb-5' />
                                    <div className='text-[#0F172A] text-xs text-center'>Audience Segmentation & Funnel Analysis</div>
                                </div>
                                <div className='border h-[170px] w-[180px] xl:w-[205px] px-[10px] xl:px-[14px] py-[25px] xl:py-[35px] border-[#2563EB] hover:shadow-ga4Show rounded-lg flex flex-col justify-between items-center gap-[27px]'>
                                    <img src='https://storage.googleapis.com/website-bucket-uploads/ua-and-ga4/data-collection%20(8).png' alt='' className='mx-auto pb-5' />
                                    <div className='text-[#0F172A] text-xs text-center'>Privacy-Compliant Data Collection</div>
                                </div>
                                <div className='border h-[170px] w-[180px] xl:w-[205px] px-[10px] xl:px-[14px] py-[25px] xl:py-[35px] border-[#2563EB] hover:shadow-ga4Show rounded-lg flex flex-col justify-between items-center gap-[27px]'>
                                    <img src='https://storage.googleapis.com/website-bucket-uploads/ua-and-ga4/order-tracking%20(1).png' alt='' className='mx-auto pb-5' />
                ...
                <section className='px-[4%] 3xl:px-[6%] py-8 md:pt-14 md:pb-10 flex max-md:flex-col justify-between items-center w-full gap-8'>
                    <div className='flex md:w-[45%] 2xl:w-[50%] items-start gap-5'>
                        <div className='mt-14'>
                            <img src='https://storage.googleapis.com/website-bucket-uploads/ua-and-ga4/Screenshot_143.png' alt='' className='2xl:w-[225px]' />
                        </div>
                        <div className=''>
                            <img src='https://storage.googleapis.com/website-bucket-uploads/ua-and-ga4/team-meeting-modern-office.png' alt='' className='2xl:w-[225px]' />
                        </div>
                        <div className='mt-6'>
                            <img src='https://storage.googleapis.com/website-bucket-uploads/ua-and-ga4/Screenshot_144.png' alt='' className='2xl:w-[225px]' />
                        </div>
                    </div>
                    <div className='flex flex-col gap-5 2xl:gap-6'>
                        ...
                        <div className='text-[#475569] text-sm 2xl:text-[15px] flex flex-col gap-1'>
                            ...
                            <p>Transparent processes & fast turnarounds</p>
                            <p>Flexible support plans for businesses of all sizes</p>
                            <p>100% certified Google Analytics Experts & strategists</p>
                        </div>
                        ...
                        <div onClick={scrolling} className='flex items-center gap-6 group w-max'>
                            ...
                            <img src='https://storage.googleapis.com/website-bucket-uploads/ua-and-ga4/Vector.png' alt=''
                            ...
                            <Slider ref={testimonialSliderRef} {...testimonialSettings}>
                                <div className=''>
                                    <div className='flex max-md:flex-col justify-between items-start md:items-center gap-6 px-[26px] py-[20px] border-t-[10px] border-r-[10px] rounded-[20px] border-[#E06B2E]'>
                                        <img src='https://storage.googleapis.com/website-bucket-uploads/ua-and-ga4/Male_Testimonial.png' alt='' className='' />
                                            ...
                                            <div className='flex justify-between items-start'>
                                                <div className='flex flex-col gap-1.5 2xl:gap-1.5'>
                                                    ...
                                                    <div className='flex items-center gap-1'>
                                                        <img src='https://storage.googleapis.com/website-bucket-uploads/ua-and-ga4/star.png' alt='' />
                                                        <img src='https://storage.googleapis.com/website-bucket-uploads/ua-and-ga4/star.png' alt='' />
                                                        <img src='https://storage.googleapis.com/website-bucket-uploads/ua-and-ga4/star.png' alt='' />
                                                        <img src='https://storage.googleapis.com/website-bucket-uploads/ua-and-ga4/star.png' alt='' />
                                                        <img src='https://storage.googleapis.com/website-bucket-uploads/ua-and-ga4/star.png' alt='' />
                                                ...
                                                <div className='bg-[#ED7536] p-[10px] rounded max-lg:hidden'>
                                                    <img src='https://storage.googleapis.com/website-bucket-uploads/ua-and-ga4/%E2%80%9C.png' alt='' />
                                                </div>
                                            </div>
