    ...
    <section className="pb-12">
        ...
        <div className="w-4/5 mx-auto space-y-4 py-4">
            ...
            <div className="md:flex space-y-2">
                ...
                <div className="md:w-2/5 md:text-right">
                    <button className="border-b-2 border-rose-400 px-4 py-2 text-gray-200 rounded bg-slate-800 hover:bg-cyan-500 hover:text-slate-800 hover:border-slate-600 tracking-wider">Apply Now</button>
                </div>
            </div>
        </div>
        <div className="w-4/5 mx-auto space-y-4 py-4">
            ...
            <div className="md:flex space-y-2">
                ...
                <div className="md:text-right md:w-2/5">
                    <button className="border-b-2 border-rose-400 px-4 py-2 text-gray-200 rounded bg-slate-800 hover:bg-cyan-500 hover:text-slate-800 hover:border-slate-600 tracking-wider">Apply Now</button>
                </div>
            </div>
        ...
        <div className="w-4/5 mx-auto space-y-4 py-4">
            ...
            <div className="md:flex space-y-2">
                <div className="md:w-3/5">
                <h2 className="text-lg font-semibold">
                    Tech Lead - Strategy and solution
                </h2>
                <p>
                    To be responsible for managing, mentoring and growing the team of solution engineers to enable the best use of Cloud, ML, Frontend and Backend programming framework.
                </p>
                </div>
                <div className="mt-2 mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" className="fill-cyan-500 w-6 inline" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
