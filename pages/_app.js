...
const router = useRouter();
  ...
  {router.pathname=="/server-side-tracking" || router.pathname=="/dv360-a" || router.pathname.includes("admin")|| router.pathname=="/ecommerce"|| router.pathname=="/ga4"|| router.pathname=="/dv360"|| router.pathname=="/gtm" || router.pathname=="/cookie-webinar" || router.pathname=="/gtmNew" || router.pathname=="/ga41"  ? <Component {...pageProps} /> :<><Head>
