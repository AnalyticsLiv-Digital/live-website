...
const router = useRouter();
  ...
  {router.pathname=="/dv360-a" || router.pathname.includes("admin")|| router.pathname=="/ecommerce"|| router.pathname=="/ga4"|| router.pathname=="/dv360"|| router.pathname=="/gtm" ? <Component {...pageProps} /> :<><Head>
