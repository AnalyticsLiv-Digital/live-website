            ...
            <header id="analyticsliv-navbar" className="sticky top-0 z-50">
                <div className="sticky top-0 z-50 bg-header-linear h-[55px] sm:h-[50px] text-white flex justify-center items-center px-2">
                    <div className="text-xs max-sm:py-1.5 sm:text-base md:text-base font-normal text-center flex max-sm:flex-col max-sm:gap-1 justify-center items-center">
                        ...
                        <a href="tel:+918320576622" className="call-now ml-2 sm:ml-5 bg-white px-2 py-1 sm:px-3 sm:py-[5px] rounded-[5px]"><div className="flex justify-center items-center text-[#0E1947] text-[11px] sm:text-sm md:text-[13px] sm:hover:underline sm:hover:text-[13.2px] font-bold">
                            Call Us Now
                ...
                <div className="sticky min-w-full top-[55px] sm:top-[50px] z-50 bg-white ">
                    {/* <div> sm:w-1/3*/}
                                ...
                                >
                                    ...
                                    <nav className="lg:flex text-center">
                                        <ul className="lg:flex text-[10px] xl:text-[14px]  font-semibold text-[#0E1947] text-left lg:text-center z-[-1] lg:z-auto lg:mr-4 lg:w-auto items-center tracking-wide">
                                            <li
                                                className=" flex items-center gap-[5px] hover:border-b-2 hover:border-[#0E1947] duration-100 delay-75 ease-in-out py-2 cursor-default"
                                                onMouseEnter={() => {
                                                    ...
                                                    <div className="w-full">
                                                        {isWebServices && (
                                                            <motion.div
                                                                ...
                                                                className="top-[37px] xl:top-[42px] left-0 absolute w-full text-sm z-[9999] bg-header-linear shadow-xl text-white font-semibold"
                                                            >
                                                                <div className="flex w-full">
                                                                    <div className="container w-[43%] pt-5 pb-5 flex justify-evenly items-center">
                                                                        <div className="w-[40%] ml-[0%] text-start">
                                                                        ...
                                                                        <div className="w-[39%] ml-[0%] flex py-4">
                                                                            {hoveredIndex !== null && (
                                                                                <motion.div
                                                                                    initial={{ opacity: 0, y: -10 }}
                                                                                    animate={{ opacity: 1, y: 0 }}
                                                                                    transition={{ type: "spring", stiffness: 300, damping: 20 }}
                                                                                    className="py-2 text-start grid grid-cols-1 2xl:grid-cols-1 max-2xl:w-full justify-items-start gap-5 2xl:gap-5 rounded-md max-h-[500px]"
                                                                                >
                                                                                    {servicesData[hoveredIndex]?.links?.map((link, linkIndex) => (
                                                                                        <div key={linkIndex} className="">
                                                                                            ...
                                                                                            <Link
                                                                                                href={link?.href}
                                                                                                onClick={() => setIsSWebervices(false)}
                                                                                                className="text-[10px] text-start xl:text-[11px] 2xl:text-[13px] font-normal text-white opacity-70 hover:opacity-100"
                                                                                            >
                                                                                                {link?.label}
                                                                                            </Link>
                                                                                        </div>
                                                                        ...
                                                                        <div className="bg-white p-4 2xl:px-5 2xl:py-3 rounded-[20px] text-center mb-7 w-[51%] 2xl:w-[50%]">
                                                                            {
                                                                                isSubmit ?
                                                                                    <>
                                                                                        <div className='analyticsliv-form-thankyou flex flex-col justify-between items-center gap-4 relative text-slate-700'>
                                                                                            <img
                                                                                    ...
                                                                                    <div className="analyticsliv-form flex flex-col items-center justify-evenly min-h-[245px]">
                                                                                        ...
                                                                                        <form className="flex flex-col items-center h-full w-full" onSubmit={handleSubmit}>
                                                                                            <input autoComplete="off" className="border border-[#DBDBDB] text-gray-600 placeholder-slate-300 font-normal focus:outline-none py-1.5 2xl:py-2 px-5 h-[28px] rounded-[30px] w-full text-[10px]" placeholder="Full Name*" type="text" id="fullName" name="name" value={formValues?.name} onChange={handleChange} />
                                                                                            <div className="flex items-center gap-4 w-full text-[10px] mt-3">
                                                                                                <input autoComplete="off" className="border border-[#DBDBDB] text-gray-600 placeholder-slate-300 font-normal focus:outline-none py-1.5 2xl:py-2 px-5 h-[28px] rounded-[30px] w-full text-[10px]" placeholder="Email*" type="email" id="email" name="email" value={formValues?.email} onChange={handleChange} />
                                                                                                <input autoComplete="off" className="border border-[#DBDBDB] text-gray-600 placeholder-slate-300 font-normal focus:outline-none py-1.5 2xl:py-2 px-5 h-[28px] rounded-[30px] w-full text-[10px]" placeholder="Mobile" type="number" id="contact" name="contact" value={formValues?.contact} onChange={handleChange} />
                                                                                            </div>
                                                                                            <input autoComplete="off" className="border border-[#DBDBDB] mt-3 text-gray-600 placeholder-slate-300 font-normal focus:outline-none py-1.5 2xl:py-2 px-5 h-[28px] rounded-[30px] w-full text-[10px]" placeholder="Website url*" type="text" id="website" name="url" value={formValues?.url} onChange={handleChange} />
