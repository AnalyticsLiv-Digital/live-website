...
const BlogBanner = ({ blogData }) => {
    const Banners = [
        ...
        { related: 'cro', img: 'https://storage.googleapis.com/website-bucket-uploads/home_page/Images_and_Icons/Blog_Banner_For_CRO_1_V1.png', path: '/services/conversion-rate-optimization' },
        { related: 'googleAds', img: 'https://storage.googleapis.com/website-bucket-uploads/home_page/Images_and_Icons/Blog_Banner_For_GAds_1_V1.png', path: '/services/ppc' },
