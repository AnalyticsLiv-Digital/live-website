        ...
        <div className="w-10/12 text-center lg:text-left lg:w-1/4 mx-auto py-4">
            <div className="relative text-white">
                ...
                <div className="ml-0 flex">
                    ...
                    <span ><Link href="tel:+918320576622">+91 83205 76622</Link></span>
                </div>
            ...
            <Link href="https://m.facebook.com/100070503960704/"><svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24" className="w-7 mt-4 mx-2 fill-white">
                ...
                <Link href="https://www.instagram.com/analyticsliv_digital"><svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet"  viewBox="0 0 256 256" className="w-7 mt-4 mx-2 fill-white">
