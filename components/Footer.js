                        ...
                        <footer className="bg-cover bg-opacity-60 f">
                            <div className='relative opacity-100 max-sm:px-3'>
                                                ...
                                                <div className='max-[381px]:flex-wrap max-sm:flex max-[381px]:gap-2 max-[400px]:gap-5 max-sm:gap-12 max-sm:w-[90dvw] py-2'>
                                                    <div className='ml-0 flex items-start [381px]:mb-[3px] max-[381px]:gap-2'>
                                                        ...
                                                        <div className='text-[13px] font-normal leading-5'>
                                                            <a href="mailto:sales@analyticsliv.com" className='analyticsliv-email opacity-[60%] text-[#efefef]'>sales@analyticsliv.com</a>
                                                        </div>
                                                    </div>
                                                    <div className='ml-0 msm:pt-2 flex items-center '>
                                                        <FaPhone className='opacity-[30%] w-[18px] h-[18px] mr-[7px] max-[374px]:ml-1' />
                                                        <span className='analyticsliv-contact text-[13px] font-normal leading-5 opacity-[60%] text-[#efefef]'><a href="tel:+918320576622">+91 83205 76622</a></span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className='mb-4'>
                                                ...
                                                <div className='max-[381px]:flex-wrap max-sm:flex max-[381px]:gap-2 max-[400px]:gap-5 max-sm:gap-12 max-sm:w-[90dvw] py-2'>
                                                    <div className='ml-0 flex items-start [381px]:mb-[3px] max-[381px]:gap-2'>
                                                        <IoIosMail className='opacity-[30%] w-[21px] h-[22px] sm:mr-[7px]' />
                                                        <div className='text-[13px] font-normal leading-5'>
                                                            <a href="mailto:hr@analyticsliv.com" className='analyticsliv-email opacity-[60%] text-[#efefef]'>hr@analyticsliv.com</a>
                                                        </div>
                                                    </div>
                                                    <div className='ml-0 msm:pt-2 flex items-center '>
                                                        <FaPhone className='opacity-[30%] w-[18px] h-[18px] mr-[7px] max-[374px]:ml-1' />
                                                        <span className='analyticsliv-contact text-[13px] font-normal leading-5 opacity-[60%] text-[#efefef]'><a href="tel:+919998835732">+91 99988 35732</a></span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className='mb-4'>
                                                ...
                                                <div className='max-[381px]:flex-wrap max-sm:flex max-[381px]:gap-2 max-[400px]:gap-5 max-sm:gap-12 max-sm:w-[90dvw] py-2'>
                                                    <div className='ml-0 flex items-start [381px]:mb-[3px] max-[381px]:gap-2'>
                                                        <IoIosMail className='opacity-[30%] w-[21px] h-[22px] sm:mr-[7px]' />
                                                        <div className='text-[13px] font-normal leading-5'>
                                                            <a href="mailto:support@analyticsliv.com" className='analyticsliv-email opacity-[60%] text-[#efefef]'>support@analyticsliv.com</a>
                                                        </div>
                                                    </div>
                                                    <div className='ml-0 msm:pt-2 flex items-center '>
                                                        <FaPhone className='opacity-[30%] w-[18px] h-[18px] mr-[7px] max-[374px]:ml-1' />
                                ...
                                <div className='flex items-center pb-4 justify-center opacity-[50%]'>
                                    <div className='text-[14px] font-normal text-white'>© Created by Analytics Liv Digital LLP, All rights reserved.&nbsp;&nbsp;
