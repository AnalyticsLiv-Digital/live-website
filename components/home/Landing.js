...
const Landing = () => {
  return (
    <section className='font-lato px-3 pb-8'>
      <div className='flex flex-col pt-10 md:pt-16 gap-4 md:gap-6 2xl:gap-10 justify-center text-center items-center text-[#0E1947]'>
        ...
        <div className='flex max-md:flex-col justify-center items-center max-md:mt-2 gap-2 md:gap-12'>
          <button className='mainbutn'>Get Free Audit</button>
          <button className='mainbutn-opposite max-md:px-12'>Talk to Sales</button>
        </div>
      </div>
    </section>
  )
