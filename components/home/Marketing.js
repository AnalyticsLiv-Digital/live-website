...
const Marketing = () => {
    ...
    return (
        <section className='about font-gilroy'>
            <div className='px-4 md:px-20 pt-8 md:pt-11 pb-8 md:pb-16'>
                <div>
                    <div className='flex items-center justify-center'>
                        <h2 className='text-maintext lg:text-[28px] text-2xl font-semibold not-italic text-center'>GOOGLE MARKETING PLATFORM PARTNER</h2>
                    </div>
