                ...
                <div>
                    ...
                    <div className='flex flex-col lg:flex-row justify-between items-center pt-8'>
                        ...
                        <div data-aos="fade-left" data-aos-once="true" className='lg:w-2/5 lg:pt-0 pt-5'>
                            ...
                            <h3 className='text-maintext text-3xl font-semibold leading-[1.3em] not-italic pb-5'>How are we Helpful?</h3>
                            <p className='text-[#000] text-[18px] font-normal leading-[1.7em] not-italic pb-10'>The Google Marketing Platform is a unified analytics and marketing platform that enables meaningful insights for effective marketing steering and activation. If you are looking for help implementing Google Marketing Platform products or need technical expertise for a custom project, AnalyticsLiv is here to help. <br /> <span className='mt-[18px] block'> We are more than just a digital agency — we’re a reliable partner and co-worker. AnalyticsLiv is a digitally-savvy team of Marketing and Analytics specialists with 8+ years of experience in the industry. We create data driven marketing strategies to help our clients’ businesses stand out.</span></p>
                            <div className='flex items-center justify-center'>
