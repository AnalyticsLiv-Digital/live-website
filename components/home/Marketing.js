                ...
                <div className='relative z-20 px-4 md:px-20 pt-8 md:pt-11 pb-8 md:pb-16'>
                    <div>
                        <div className='text-start'>
                            <h2 className='lg:text-[28px] text-2xl font-gilroy font-semibold text-[#fff] leading-[1.5em] tracking-wide text-center block'>GOOGLE MARKETING PLATFORM PARTNER</h2>
                        </div>
