...
const Navbar = () => {
    ...
    return (
        <>
            <nav className='sticky container mx-auto min-w-full top-0 z-50 shadow-md bg-homepagebg'>
                ...
                {/*  */}
                <div className='lg:hidden p-2 sticky top-0 left-0 right-0 z-30 bg-homepagebg'>
