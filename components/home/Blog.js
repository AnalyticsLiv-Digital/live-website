                    ...
                    <div data-aos="zoom-in" data-aos-once="true" className='text-center lg:flex items-center justify-between gap-2'>
                        <div className='lg:w-[66%]'>
                            ...
                            <div className='grid lg:grid-cols-2 lg:gap-2 gap-4'>
                                ...
                                <div className='second group home-blog rounded border border-solid border-[#DBDBDB] hover:border-[#979797]  hover:shadow-serviceoffer p-[25px] text-center relative 2xl:h-[540px] lg:h-[495px]'>
                                    <span className='bg-[#FFA9A3] text-[#000] text-xs font-bold py-1 px-3 absolute top-0 left-0'>BLOG</span>
                                    <a href="">
                                        <Image
                                            src="/blog2.png"
                        ...
                        <div className='hidden lg:grid lg:w-[33%]'>
                            ...
                            <div className='third hidden lg:grid gap-2 2xl:h-[540px] lg:h-[495px]'>
                                    ...
                                    <a href="" className='grid gap-1'>
                                        <div className='grid gap-4'>
                                            <Image
                                                ...
                                                alt="Picture of the author"
                                                priority={true}
                                                className='w-full m-auto h-[139px] 2xl:h-[180px]'
                                            />
                                        </div>
