...
const Home = () => {
    ...
    return (
        <>
        <div className='px-4 md:px-20 my-5 xl:my-0 xl:mt-5 w-full'>
            <a href='/webinar/cookie-consent'><img src='/Web Banner for Website.png' alt='web banner' /></a>
        </div>
                                    ...
                                    <div>
                                        <div className='flex lg:flex-nowrap flex-wrap items-center gap-10 mt-[80px]'>
                                            ...
                                            <div className='lg:w-[40%] w-full mx-auto flex items-center justify-center'>
                                                <img src="/Home_Page_Main_Img_1_NEW_V2.png" alt="" className='w-[650px]' />
                                            </div>
                                        </div>
                                    </div>
