                        ...
                        <div>
                            ...
                            <div className='first group home-blog rounded border border-solid border-[#DBDBDB] hover:border-[#979797] hover:shadow-serviceoffer p-[25px] text-center relative 2xl:h-[680px] xl:h-[600px] lg:h-[550px]'>
                                ...
                                <a href="">
                                    ...
                                    <p className='align-middle text-left text-xs pt-4 pb-7 text-gray-500'>The client faced difficulty migrating their website from Universal Analytics to Google Analytics 4 and had limited knowledge of GA4.</p>
                                    <div>
                            ...
                            <div className='third hidden lg:grid gap-2 2xl:h-[680px] xl:h-[600px] lg:h-[550px] overflow-scroll'>
                                <div className='home-blog group rounded border border-solid border-[#DBDBDB] hover:border-[#979797] hover:shadow-serviceoffer p-[25px] text-center relative'>
                                    ...
                                    <a href="" className='grid md:grid-cols-2 gap-1'>
                                        ...
                                        <div className='grid gap-1'>
                                            <h3 className='text-[8px] text-left text-slate-900 font-semibold whitespace-relaxed'>Skyrocket Your Campaign's CTR with a 95% Surge in 14 Days!</h3>
                                            <p className='align-middle text-left text-[6px] pt-1 pb-4 text-gray-500'>Through the strategic removal of underperforming components and the targeting of a more relevant settings, the campaign effectively increased website traffic. Remarkably, this success was achieved without compromising the caliber of website traffic.</p>
                                            <div>
                                ...
                                <div className='home-blog group rounded border border-solid border-[#DBDBDB] hover:border-[#979797] hover:shadow-serviceoffer p-[25px] text-center relative'>
                                    ...
                                    <a href="" className='grid md:grid-cols-2 gap-1'>
                                        ...
                                        <div className='grid gap-1'>
                                            <h3 className='text-[8px] text-left text-slate-900 font-semibold whitespace-relaxed'>Driving the Campaigns in DV360 to Post Click Attribution Success with a 36% reduction in CPI</h3>
                                            <p className='align-middle text-left text-[6px] pt-1 pb-4 text-gray-500'>Implementing post-click conversions in DV360 attribution led to increased conversions, a 36% lower CPI, and a notable 38% boost in overall click-through rate, showcasing the effectiveness of our refined attribution model.</p>
                                            <div>
                                                <div className='flex m-auto items-center p-1 justify-evenly border border-solid text-center border-homepagebtn cursor-pointer rounded-[10px] group-hover:bg-homepagebtn'>
                                                    <button className='font-medium text-[6px] text-[#4186F5] group-hover:text-white'>Read More</button>
                                                    <span className='text-homepagebtn group-hover:text-white'><FaLongArrowAltRight /></span>
                                ...
                                <div className='home-blog group rounded border border-solid border-[#DBDBDB] hover:border-[#979797] hover:shadow-serviceoffer p-[25px] text-center relative'>
                                    ...
                                    <a href="" className='grid md:grid-cols-2 gap-1'>
                                        ...
                                        <div className='grid gap-1'>
                                            <h3 className='text-[8px] text-left text-slate-900 font-semibold whitespace-relaxed'>From Inefficiency to Precision: Learn How AnalyticsLiv Achieved a 78% CPC Reduction for a News Publisher Giant</h3>
                                            <p className='align-middle text-left text-[6px] pt-1 pb-4 text-gray-500'>By eliminating underperforming areas and focusing on a more relevant audience, the client achieved significant cost savings through a substantial decrease in CPC. This was achieved without compromising the quality of website traffic</p>
                                            <div>
                                                <div className='flex m-auto items-center p-1 justify-evenly border border-solid text-center border-homepagebtn cursor-pointer rounded-[10px] group-hover:bg-homepagebtn'>
                                                    <button className='font-medium text-[6px] text-[#4186F5] group-hover:text-white'>Read More</button>
                                                    <span className='text-homepagebtn group-hover:text-white'><FaLongArrowAltRight /></span>
