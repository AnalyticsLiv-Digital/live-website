            ...
            <div className='bg-[#30486A] max-md:mt-16 md:h-[250px] lg:h-[350px] 2xl:h-[400px]'>
                <div className='flex max-md:flex-col 2xl:pb-5 justify-center items-center md:justify-evenly h-full md:items-end text-white'>
                    ...
                    <div className='py-7 text-center'>
                        <ScrollTrigger onEnter={() => setCounterOn(true)} onExit={() => setCounterOn(false)}>
                            <h1 className='text-4xl font-bold'>
                                {counterOn && <CountUp start={0} end={500} duration={3} delay={0} />}
                                +
                            </h1>
...
//         <section className='font-lato md:pt-52 2xl:pt-64 h-full'>
//             <div className='md:relative'>
//                 <div className="md:absolute top-[-200px] 2xl:top-[-240px] lg:left-[25%] lg:w-1/2 w-full carousel-custom" key="image">
//                     <Slider {...settings} className="w-[90%] lg:w-[100%] mx-auto">
//                         {videos.map((video) => (
//                             <div key={video.id} className="video-container w-full md:h-[250px] lg:h-[350px] 2xl:h-[400px] overflow-hidden rounded-3xl">
//                                 <iframe
//                                     src={video.url}
//                                     title={`YouTube video ${video.id}`}
//                                     frameBorder="0"
...
//                                 ></iframe>
//                                 <div className="left-[-100px] md:left-[-120px] bottom-10 transform -translate-y-36 -translate-x-3">
//                                     <img src="/Grow_Business.png" alt="Grow Business" className="" />
//                                 </div>
//                                 {/* Right Label */}
//                                 <div className="right-[-100px] md:right-[-120px] top-1/2 transform -translate-y-1/2">
//                                     <img src="/Make_data_profitable.png" alt="Make Data Profitable" className="" />
//                                 </div>
//                             </div>
//                         ))}
//                     </Slider>
...
{/* <div>
                <img src='/Grow_Business.png' alt='Grow_Business' />
            </div>
            <div>
                <img src='/Make_data_profitable.png' alt='Make_data_profitable' />
            </div> */}
// import React, { useState } from 'react';
// import Slider from "react-slick";
// import CountUp from 'react-countup';
...
//     return (
//         <section className='font-lato md:pt-52 2xl:pt-64 h-screen'>
//             <div className='md:relative'>
//                 <div className="md:absolute top-[-200px] 2xl:top-[-240px] lg:left-[25%] lg:w-1/2 w-full carousel-custom" key="image">
//                     <Slider {...settings} className="w-[90%] lg:w-[100%] mx-auto">
//                         {videos.map((video) => (
//                             <div key={video.id} className="video-container w-full h-full overflow-hidden rounded-3xl">
//                                 <iframe
//                                     src={video.url}
//                                     title={`YouTube video ${video.id}`}
//                                     frameBorder="0"
...
//                 </div>
//             </div>
//             <div className='bg-[#30486A] max-md:mt-16 md:h-[60%] lg:h-[90%] 2xl:h-[82%]'>
//                 <div className='flex max-md:flex-col justify-center items-center md:justify-evenly h-full md:items-end text-white'>
//                     <div className='py-7 text-center'>
//                         <ScrollTrigger onEnter={() => setCounterOn(true)} onExit={() => setCounterOn(false)}>
//                             <h1 className='text-4xl font-bold'>
//                                 {counterOn && <CountUp start={0} end={200} duration={3} delay={0} />}
