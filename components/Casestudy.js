...
const Casestudy = ({casestudy}) => {
  return (
    ...
    <img src={casestudy.coverimage} className="w-full md:w-[300px] h-auto"/>
      <div className="p-2 md:flex md:flex-wrap space-y-4">
      <div className="md:flex md:w-full md:space-x-4 text-center md:text-left">
          <h1 className="font-semibold text-xl md:w-4/5 text-justify tracking-wider"><Link href={`/case-studies/${casestudy.slug}`}> 
