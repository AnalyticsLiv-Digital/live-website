        ...
        <Link href="/"><img src="/static/logo.png" className="h-10 lg:mx-4 cursor-pointer"/></Link>
            <nav className="lg:flex text-center">
                ...
                <Link href="/services">Services</Link>
                    ...
                    <div style={{display : "none"}} onMouseEnter={()=>submenushow(1)} onMouseLeave={()=>submenuhide(1)} id="submenu1" className="absolute w-56 text-sm flex flex-col lg:-ml-20 lg:mt-3 divide-y bg-gray-100 bg-opacity-90 text-cyan-900 items-center align-middle font-semibold transition ease-in-out delay-1000 hover:-translate-y-1 ">
