...
${nextText}`;
  ...
  return (
    <div className="border border-gray-200/60 rounded-[32px] bg-white/85 shadow-[0_18px_60px_rgba(15,23,42,0.08)] p-5 overflow-hidden" id="resultsPanel">
      <div className="flex justify-between gap-3.5 items-start mb-3.5 flex-wrap">
        <div>
          <h2 className="m-0 text-[16.5px] tracking-tight">Results</h2>
      ...
      <div ref={pdfAreaRef}>
        <div className="flex justify-between gap-3.5 items-start flex-wrap">
          <div className="flex gap-4 items-center">
            <div
              className="w-[86px] h-[86px] rounded-full grid place-items-center border border-gray-200/60 shadow-[0_20px_45px_rgba(15,23,42,0.10)] relative"
              style={{
            ...
            <div>
              <div className="inline-flex gap-2.5 items-center px-3 py-2.5 rounded-full border border-gray-200/60 bg-white/95 shadow-[0_12px_28px_rgba(15,23,42,0.06)] font-black tracking-wide w-fit">
          ...
          <div className="min-w-[260px]">
            <div className="flex justify-between items-center border border-gray-200/60 bg-white/75 px-3 py-2 rounded-full text-[12.5px]">
              <span>Confidence</span>
              <b className="text-gray-900">{confLabel} ({scores.confidence}%)</b>
            </div>
            <div className="flex justify-between items-center border border-gray-200/60 bg-white/75 px-3 py-2 rounded-full text-[12.5px] mt-2.5">
              <span>Mode</span>
        ...
        <div className="flex gap-2 flex-wrap mt-4" aria-label="Result tabs">
          {['visuals', 'gaps', 'roadmap'].map(tab => (
            <button
              ...
              className={`border border-gray-200/60 bg-white/95 rounded-full px-3 py-2.5 text-[12.5px] font-black cursor-pointer shadow-[0_10px_22px_rgba(15,23,42,0.04)] transition-all ${activeTab === tab
          ...
          {activeTab === 'visuals' && (
            <div className="flex flex-col gap-3.5">
                ...
                <div className="grid gap-3">
                  {scores.categories.map(c => (
                    <div key={c.id} className="grid grid-cols-[210px_1fr_66px] gap-3 items-center max-md:grid-cols-1">
                      ...
                      <div className="h-3 rounded-full border border-gray-200/60 bg-gray-900/5 overflow-hidden">
                        <i
              ...
              <div
                ...
                className="border border-gray-200/60 bg-white/95 rounded-3xl shadow-[0_12px_28px_rgba(15,23,42,0.05)] p-3.5 cursor-pointer select-none transition-all hover:translate-y-[-1px] hover:shadow-[0_18px_44px_rgba(15,23,42,0.08)] relative"
              ...
              >
                ...
                <span className="absolute right-3.5 bottom-3.5 text-[11.5px] font-black text-gray-500 border border-gray-200/60 bg-white/90 px-2 py-1.5 rounded-full">
                  Click to enlarge ↗
                </span>
              </div>
            </div>
              ...
              <div>
                ...
                <ul className="list-none p-0 m-0 grid gap-3">
                  {gaps.map((g, idx) => {
                    ...
                    return (
                      <li key={idx} className="border border-gray-200/60 bg-white/95 rounded-[20px] p-3.5 shadow-[0_12px_28px_rgba(15,23,42,0.05)]">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3 max-md:grid-cols-1">
                  {recommendedServices.map(s => (
                    <div key={s.key} className="border border-gray-200/60 bg-white/95 rounded-[20px] p-3.5 shadow-[0_12px_28px_rgba(15,23,42,0.05)] relative overflow-hidden">
          ...
          {activeTab === 'roadmap' && (
            <div>
              ...
              <div className="grid lg:grid-cols-2 gap-3.5 mt-3.5 max-lg:grid-cols-1">
                <div className="border border-gray-200/60 bg-white/95 rounded-[20px] p-3.5 shadow-[0_12px_28px_rgba(15,23,42,0.05)]">
      ...
      <div>
        <h3 className="m-0 mb-2 text-[15.5px]">Unlock the PDF + request a free maturity review</h3>
        ...
        <form onSubmit={handleSubmit} className="grid lg:grid-cols-2 gap-3 max-md:grid-cols-1">
          <div className="border border-gray-200/60 bg-white/95 rounded-2xl p-3 shadow-[0_10px_22px_rgba(15,23,42,0.04)]">
...
//       return;
//     }
//     showToast('✅ Submitted. You can download the PDF now.');
//   };
...
//           </p>
//         </div>
//         <div className="flex gap-2.5 flex-wrap justify-end w-[50%]">
//           <button
//             onClick={handleCopySummary}
//             className="border border-gray-200/70 bg-white/95 text-gray-900 px-3.5 py-2.5 rounded-2xl text-[13px] font-[800] cursor-pointer inline-flex gap-2.5 items-center transition-all hover:translate-y-[-1px] hover:border-gray-900/20 hover:shadow-[0_14px_30px_rgba(15,23,42,0.08)] active:translate-y-0 active:scale-[0.99] shadow-[0_10px_26px_rgba(15,23,42,0.05)] select-none"
//             type="button"
